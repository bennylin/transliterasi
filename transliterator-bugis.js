/*!
* transliterator.js (Bugis-Latin / Bugis Script to Latin)
* https://bennylin.github.com/transliterasi/bugis.html
*
* Copyright 2019, Bennylin @bennylin
* Released under the CC-BY-SA 4.0
*
* Date: 1 December 2019 - v 0.1
*
*
*
*/
    ...
    for (var i = 0, j = 0; i < str.length; i++) {
        if (regexp_file[str[i]] && regexp_file["ᬃ"] == "r") { //jawa->latin
            if (str[i] == "ᬳ") { //ha
                ...
                else if (i > 0 && (str[i] == "ᬶ" || str[i] == "ᬸ" || str[i] == "ᬾ" || str[i] == "ᭂ") && (str[i - 1] == "ᬅ" || str[i - 1] == "ᬏ" || str[i - 1] == "-" || str[i - 1] == "ᬑ" || str[i - 1] == "ᬉ")) { trans = trans.ganti(j, regexp_file[str[i]]); j++; }
